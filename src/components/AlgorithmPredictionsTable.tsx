...
const ConfidenceBadge = memo(function ConfidenceBadge({ confidence }: { confidence: number }) {
  const colorClass = useMemo(() => {
    if (confidence >= 70) return "bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-300";
    if (confidence >= 60) return "bg-cyan-100 text-cyan-800 dark:bg-cyan-900 dark:text-cyan-300";
