...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    default: "rounded-xl border bg-card text-card-foreground shadow-sm transition-all duration-200",
    interactive: cn(
      "rounded-xl border bg-card text-card-foreground shadow-sm",
      "transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/20",
      "card-shine hover-float"
    ),
    premium: cn(
      "rounded-xl border border-primary/10 bg-gradient-to-br from-card via-card to-card/95 text-card-foreground shadow-lg",
      "transition-all duration-300 hover:shadow-xl hover:-translate-y-1.5 hover:border-primary/30",
      "relative overflow-hidden card-shine glow-pulse-hover",
    ...
    glass: cn(
      ...
      "transition-all duration-300 hover:shadow-xl hover:border-primary/20 hover:-translate-y-0.5"
    ),
  };
